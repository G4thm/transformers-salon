    ...
    <PageShell>
      <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="mb-10 flex max-w-3xl flex-col gap-5">
          <Badge>Offers</Badge>
          <h1 className="text-5xl font-black">Salon campaigns without public price display.</h1>
          ...
          {content.offers.map((offer) => (
            <Card key={offer.id} className="glass overflow-hidden">
              <div className="relative aspect-[16/10]">
                <Image src={offer.image} alt={offer.title} fill sizes="(min-width: 768px) 50vw, 100vw" className="object-cover" />
              </div>
